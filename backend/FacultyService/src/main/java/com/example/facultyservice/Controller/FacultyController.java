...
public class FacultyController {
    ...
    public ResponseEntity<String> registerFacultyWithAuth(@RequestBody Faculty faculty) {
        return facultyService.registerFacultyWithAuth(faculty);
    }

    @PostMapping("/bulk-register")
    public ResponseEntity<String> bulkRegisterFaculty(@RequestPart("file") MultipartFile file) {
    ...
    public ResponseEntity<String> getApprovedStudent(@PathVariable int facultyId, @PathVariable int projectId,
