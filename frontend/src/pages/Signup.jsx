...
import { BookOpen, Eye, EyeOff, GraduationCap, Lock, Mail, Shield, Star, User, Users } from 'lucide-react';
...
const Signup = () => {
    ...
    const roles = [
        { value: 'STUDENT', label: 'Student', icon: GraduationCap, description: 'Apply for projects and collaborate' },
        { value: 'FACULTY', label: 'Faculty', icon: Users, description: 'Create and manage projects' }
    ];
                        ...
                        <div className="relative">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                                    Join our community of students and faculty working together on innovative projects.
                                </p>
                    ...
                    >
                        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 lg:p-10 border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="mb-8">
                                ...
                                <p className="text-gray-600 dark:text-gray-400">Join our academic community today</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <label className="text-sm text-gray-700 dark:text-gray-300">
                                        I agree to the{' '}
                                        <Link to="/terms" className="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                                            Terms & Conditions
                                        </Link>
                                        {' '}and{' '}
                                        <Link to="/privacy" className="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                                            Privacy Policy
                                        </Link>
                                    </label>
                                </div>
                                ...
                                >
                                    {loading ? (
                                        <>
                                            <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
